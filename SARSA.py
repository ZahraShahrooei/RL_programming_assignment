...
Q, pi, return_ep = SARSA(eps, alpha,ep=10000)
...
# Smoothing the return with a moving window of size 100
smoothed_return_ep = moving_average(return_ep, 100)
plt.figure(figsize=(10, 6))

# Plot original returns with lower opacity
plt.plot(return_ep, alpha=0.3, label="Original Returns")
